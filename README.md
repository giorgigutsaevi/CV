...
| Project | Description |
| -- | :--: |
| **MERN Recipe Bank App** <br><br> **(in development)** <br><br> Food Recipe App built with a MERN stack. The app allows users to create an account, login, logout and perform a CRUD operation. Users can add, edit, delete and view their recipes. The app uses react router v6. <br><br> **Tech Stack** <br> React, Node.js, Express.js, MongoDB, Axios <br><br>| **[MERN Recipe App](https://github.com/giorgigutsaevi/recipr-mern)**<br><br> ![]() |
