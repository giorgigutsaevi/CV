...
| Project | Description |
| -- | :--: |
| **MERN Recipe Bank App** <br><br> **(in development)** <br><br> Food Recipe App built with a MERN stack. The app allows users to create an account, login, logout and perform a CRUD operation. Users can add, edit, delete and view their recipes. The app uses react router v6. <br><br> **Tech Stack** <br> React, Node.js, Express.js, MongoDB, Axios <br><br>| **[MERN Recipe App Repo](https://github.com/giorgigutsaevi/recipr-mern)**<br><br> ![]() |
| **React Movie Search App** <br><br> This is my second React-based App. The app uses the Movie Database (TMDB) API to search for all movies based on a particular search query and if the query is satisfied, the movie cards are then rendered out neatly on the page. <br><br> **Tech Stack** <br> React, TMDB API, CSS <br><br>| **[React Movie Search Repo](https://github.com/giorgigutsaevi/react-movie-search-app)**<br><br> ![](./gifs/react-movie-search.gif) |
| **React Notes App** <br><br> A React-based Notes App. The aim of the project is to solidify my React skills as a developer and to constantly try to learn new technologies. This app allows users to save their notes in localStorage via useEffect hook, filter/search notes based on keywords, delete the saved notes and toggle between light and dark mode. <br><br> **Tech Stack** <br> React, nanoid, CSS <br><br>| **[React Notes Repo](https://github.com/giorgigutsaevi/react-notes-app)**<br><br> ![](./gifs/react-notes.gif) |
